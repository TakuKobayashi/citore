...
class Mone::LinebotFollowerUser < LinebotFollowerUser
  has_many :answers, as: :answer_user, class_name: 'Mone::Answered'

  def say!(event: event)
    input = event.message['text']
    output = Mone::LinebotFollowerUser.get_output(input)
